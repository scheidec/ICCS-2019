...
Adding code for country-level level-2 variables for multi-level regression. For 1999 and 2009, includes all 21 countries from IJCS paper
...
**JO Next step coding task, create variable for GDP 2015 "gdp_imf15"
Identify data on IMF site, and document in xls for all countries in the 2016 wave


**JO next step coding task, merge LCA results back into R file:
New dat file in “lcadata” folder
JA advice: combine to LCA output to Rproj, follow R for data science book: "full_join"
c:\Users\user\Documents\GitHub\ICCS\ICCS\lcadata\tbl_14_wclass.dat
