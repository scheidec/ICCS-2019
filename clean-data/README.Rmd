...
JO copied 1st chunk of code to try to run 1st lines that produce binded file before selecting variables.
```{r}
...
tbl1 <- files %>%
  magrittr::extract(1:28) 
```

JO can't figure out code. 
See deliverable file for JO coding request.
